...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About — Spkrs" },
      { name: "description", content: "The philosophy and standards behind Spkrs, the world's curated marketplace for reference-grade audio." },
      { property: "og:title", content: "About — Spkrs" },
  ...
  return (
    <div className="mx-auto max-w-4xl px-8 pt-24 pb-32">
      ...
      <div className="mt-16 grid gap-12 text-lg leading-relaxed text-muted-foreground md:grid-cols-2">
        <p>Spkrs was founded in 2019 by a small collective of engineers, collectors and listeners who could not find a marketplace worthy of the equipment they cared about. So we built one.</p>
        <p>Every piece on Spkrs is hand-selected and physically inspected. We work directly with the world's most exacting makers and most trusted private collectors to bring rare, reference-grade equipment to a community that understands its value.</p>
      </div>
